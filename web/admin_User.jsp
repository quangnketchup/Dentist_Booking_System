                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown"><a href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a href="" class="dropdown-item nav-link text-primary text-center">Hồ sơ cá nhân</a>
                            </div>
                        </li>
                        <li class="nav-item"><a href="ShowServiceController" class="nav-link SA">Dịch vụ</a></li>
                        <li class="nav-item"><a href="admin_User.jsp" class="nav-link sa">Bệnh nhân</a></li>
                        <li class="nav-item"><a href="admin_Feedback.html" class="nav-link sa">Phản hồi</a></li>
                        <li class="nav-item"><a href="ShowDoctorController" class="nav-link sa">Bác sĩ</a></li>
                        <li class="nav-item"><a href="admin_Booking.html" class="nav-link sa">Lịch Hẹn</a></li>
                        ...
                        <table id="serviceTB" class="table table-image table-bordered table-hover text-align-center">
                            ...
                            <form action="UpdatePatientController">
                                <tr>
                                    ...
                                    <td><input type="submit" class="btn btn-block btn-outline-success" name="action" value="Cập Nhật"></td>
