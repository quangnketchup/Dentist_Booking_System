...
if(img.getServiceID()==service.getServiceID()){
    ...
    <tr>
      ...
      <td scope="row"><%=demm%></td>
      <td><img src="<%=img.getImage()%>" style="height:100px;width: 100px"/></td>
      <td><a href="DeleteImageServiceController?serviceID=<%=service.getServiceID()%>&imageID=<%=img.getImageID()%>">X</a></td>
        <%
            }}%>
    </tr>
