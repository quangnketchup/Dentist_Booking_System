<%-- 
    Document   : team
    Created on : Jul 25, 2022, 2:20:07 PM
    Author     : nguye
--%>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown"><a href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a href="services.html"
                                class="dropdown-item nav-link text-primary text-center">serviceType1</a>
                    ...
                    <li class="nav-item dropdown"><a href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a href="admin_Account.html" class="dropdown-item nav-link text-primary text-center">Hồ sơ
                                cá nhân</a>
                        </div>
                    </li>
            ...
            <div class="row mb-5">
                <div class="col-md-3">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <p>Nha Khoa DentalCare cung cấp đầy đủ các loại hình điều trị như: Tổng quát, Phục hình răng sứ,
                            Cấy ghép
